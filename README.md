...
OSM_Roundabout: A code that takes input ".osm" file for an area and extracts all the roundabouts in that area.".osm" file can be obtained from open street map website. As an example, code is implemented with 'test_file.osm'. 
